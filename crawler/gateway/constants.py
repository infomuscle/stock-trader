...
# DART_LABLES = ['ifrsfullAssets', 'ifrsfullLiabilities', 'ifrsfullEquity', 'ifrsfullEquityAndLiabilities']
DART_LABLES = {'ifrsfullAssets': 'total_assets', 'ifrsfullLiabilities': 'total_liabilities', 'ifrsfullEquity': 'total_equity'}
